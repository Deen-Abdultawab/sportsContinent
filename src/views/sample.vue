    ...
    <section>
        <div class="w-[78.33%] tab:w-[90%] mx-auto mt-[5rem] ">
            ...
            <div v-else>
                    ...
                    class="grid grid-cols-customGrid2 gap-4" >
                        ...
                        >
                            <div class="flex-1 min-h-[250px]">
                                ...
                                alt="Product Image" 
                                class="w-full h-full object-fill rounded-lg mb-4"
                                />
                            </div>
                ...
                <div class="pagination flex items-center justify-center gap-[1.5rem] mb-[5.3rem] mt-[5rem]">

    ...
    <section class="bg-[#eae8e8] font-Raleway">
        <div class="lg:flex">
            ...
            <div 
             v-if="closeBackdrop"
             @click.self="toggle"
            class="desk:block hidden sidebar z-[9999999] menubg fixed top-0 left-0 w-full exclude-from-print menubg">
            ...
            <div class="flex-1 flex-grow">
                <nav class="flex w-full bg-[#FAFAFA] justify-end desk:justify-between py-[1rem] px-[3.75rem] !sticky top-0 min-[370px]:pt-5 items-center z-[999]">
                    ...
                    <div class="lg:hidden flex items-center gap-6">
                      <settingIcon class="w-[2rem] h-[2rem] cursor-pointer" @click="toggleAdminDropDown"/>
                      <div @click="toggle" class="cursor-pointer z-[999999999]">
                        <svg
                    ...
                    <div class="absolute right-0">
                        <div class="absolute top-[4rem] right-[2rem] bg-white min-w-[230px] rounded-[0.5rem] transitionItem shadow-2xl "
...
import settingIcon from "@/components/icons/UserSettingIcon.vue"
